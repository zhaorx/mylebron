...
var (
	...
	cacheOrdersShippingIdPrefix = "cache:orders:shipping:id:"
)
...
func (m *defaultShippingModel) Insert(ctx context.Context, data *Shipping) (sql.Result, error) {
	ordersShippingIdKey := fmt.Sprintf("%s%v", cacheOrdersShippingIdPrefix, data.Id)
...
func (m *defaultShippingModel) FindOne(ctx context.Context, id int64) (*Shipping, error) {
	ordersShippingIdKey := fmt.Sprintf("%s%v", cacheOrdersShippingIdPrefix, id)
	var resp Shipping
	err := m.QueryRowCtx(ctx, &resp, ordersShippingIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultShippingModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheOrdersShippingIdPrefix, primary)
}
